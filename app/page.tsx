          ...
          <div className="lg:col-span-4 space-y-6 lg:pr-12">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="text-xl font-bold tracking-tighter text-white">Stay in the loop</h3>
                <p className="text-sm text-gray-300">Subscribe to our newsletter to receive updates, tips, and news about epanet-js
                  and water network modeling.</p>
              </div>
